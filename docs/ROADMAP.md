...
| **1 (MVP)** | 8주 | 100명 베타 | Google OAuth + Library 4-pane + Ingestion 자동 사전 생성 + Chat+Citation | 🚧 S7a ✅ · S7b Auth Stub/Mock 🚧 · S8 arXiv import ✅ · S9 Ingestion ✅ · S10 LLM Abstraction ✅ · S11 Auto pre-gen ✅ · S12 Chat+Citation ✅ (다음 S13 Library 4-pane) |
