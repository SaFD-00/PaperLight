...
> **마지막 갱신**: 2026-05-20 (Phase 1 S14 Markup 완료)
> **참조**: [ROADMAP.md](./ROADMAP.md) — Phase별 task 분해
> **현재 마일스톤**: → **Phase 1** — S7a ✅ · S7b 🚧 (Auth Stub/Mock) · S8 ✅ · S9 ✅ · S10 ✅ · S11 ✅ (Auto pre-gen) · S12 ✅ (Chat+Citation) · S13 ✅ (Library 4-pane) · S14 ✅ (Markup) · 다음 **S15 Observability**
...
### 18.5 다음 액션
1. **다음 진입점**: **S15 Observability** — Sentry + PostHog + Langfuse 통합(트레이스 가시화) → S16 CI. (S14 Markup ✅ 완료: `/api/annotations` 하이라이트·노트·export + pdf.js overlay + Floating Menu 5액션 + NotesPanel /ai.)
