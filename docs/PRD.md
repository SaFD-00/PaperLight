...
> **마지막 갱신**: 2026-06-03 (Phase 1 S16 CI 완료 — MVP 코드 완료, 라이브 배포·자격증명만 대기)
> **참조**: [ROADMAP.md](./ROADMAP.md) — Phase별 task 분해
> **현재 마일스톤**: → **Phase 1** — S7a ✅ · S7b 🚧 (Auth Stub/Mock — 코드 완료, 자격증명 보류) · S8 ✅ · S9 ✅ · S10 ✅ · S11 ✅ (Auto pre-gen) · S12 ✅ (Chat+Citation) · S13 ✅ (Library 4-pane) · S14 ✅ (Markup) · S15 ✅ (Observability) · S16 ✅ (CI) — **Phase 1 MVP 코드 완료**
...
### 18.5 다음 액션
1. **다음 진입점**: **Phase 2** — F-13 Podcast / F-09 Deep Search / Export(Notion·Obsidian) / Preview(F-07). (**Phase 1 MVP 코드 완료: S7~S16.** 라이브 배포·OAuth 자격증명만 대기. S16 CI ✅: GitHub Actions 3-job.)
